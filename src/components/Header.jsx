...
export default function Header() {
    ...
    return (
        <>
            <header className='w-full h-16 fixed z-50 backdrop-blur-[12px] bg-transparent'>
                <section className='container h-full mx-auto px-2 py-2 xl:px-0 flex items-center justify-between'>
                    ...
                    <div className="ml-auto h-full items-center gap-8 hidden md:flex">
                        ...
                        <Link className="text-sm text-tertiary-dark dark:text-tertiary-light" to="/services" onClick={closeNavBar}>What We Do?</Link>
                        <Link className="text-sm text-tertiary-dark dark:text-tertiary-light" to="/clients" onClick={closeNavBar}>Past Work</Link>
                        <Link className="text-sm text-tertiary-dark dark:text-tertiary-light" to="/blogs" onClick={closeNavBar}>Blogs</Link>
                        <Link className="text-sm text-tertiary-dark dark:text-tertiary-light bg-secondary-light dark:bg-secondary-dark px-4 py-2 rounded-md font-medium transition-colors" to="/quote" onClick={closeNavBar}>Get a Quote</Link>
                    </div>
                    <div
            ...
            <nav className={`fixed left-0 top-16 z-50 h-screen w-full overflow-auto bg-transparent backdrop-blur-[12px] md:-translate-x-full transition-transform ease-in-out duration-500 ${navbarVisible ? 'pointer-events-auto transform-none' : 'pointer-events-none transform -translate-x-full'}`}>
                <div className="flex flex-col items-start gap-4 uppercase font-extralight">
                    ...
                    <Link className="w-full text-lg text-tertiary-dark dark:text-tertiary-light border-grey-dark p-4 border-b-[0.50px] border-tertiary-light dark:border-tertiary-dark" to="/services" onClick={closeNavBar}>What We Do?</Link>
                    <Link className="w-full text-lg text-tertiary-dark dark:text-tertiary-light border-grey-dark p-4 border-b-[0.50px] border-tertiary-light dark:border-tertiary-dark" to="/clients" onClick={closeNavBar}>Past Work</Link>
                    ...
                    <Link className="w-full text-lg text-tertiary-dark dark:text-tertiary-light border-grey-dark p-4 border-b-[0.50px] border-tertiary-light dark:border-tertiary-dark" to="/quote" onClick={closeNavBar}>Get a Quote</Link>
                </div>
            </nav>
        </>
    );
