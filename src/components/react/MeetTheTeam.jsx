        ...
        <div className="mt-44 container mx-auto px-6 md:px-8">
            <div className="grid grid-cols-1 xl:grid-cols-2">
                <div>
                    ...
                    <p className="py-2 text-balance text-lg font-normal tracking-tight text-gray-400">
                    ...
                    <Link to="https://www.upwork.com/freelancers/~012d6eb926a1f7a86a" target='_blank' className="py-2 border-none outline-none font-medium text-tertiary-dark dark:text-tertiary-light leading-none tracking-tight inline-flex items-center gap-1 group">
                        View Profile
