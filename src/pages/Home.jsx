...
export default function Home() {
    ...
    return (
        <main>
            ...
            <section id='hero' className='relative pt-32 mx-auto h-screen px-6 xl:px-0 flex flex-col items-center overflow-hidden'>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            <section id="clients" className="mt-32 container mx-auto px-6 xl:px-0">
