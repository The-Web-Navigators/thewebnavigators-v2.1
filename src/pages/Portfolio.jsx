  ...
  return (
    <>
      ...
      <section id="portfolio" className={`mt-20 ${isHome ? '' : 'container mx-auto'}`}>
        <motion.h2
          className={`bg-gradient-to-br from-black to-black/40 dark:from-white dark:to-white/40 bg-clip-text py-2 text-5xl font-medium text-transparent tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl ${isHome ? 'text-center' : 'px-6 xl:px-0'}`}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.h3
          className={`mt-2 text-lg tracking-tight text-gray-400 text-balance md:text-xl ${isHome ? 'text-center' : 'px-6 xl:px-0'}`}
        ...
        {isHome ? (
          ...
          <motion.div
            className="mt-8 grid grid-cols-2 xl:grid-cols-3 gap-6 px-6 xl:px-0"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
